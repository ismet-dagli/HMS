...
def test():
    ...
    #PRINT THE SUMMARY, LAYERS, PARAMATERS of the NETWORK
    # summary(net)
    ...
    # device_2 = 'cuda'
    # batch=1
    # x = torch.rand(batch,3,32,32).to(device_2)
    # net= net.to("cuda")
    ...
    print("average of exec time:", str((last_time - first_time)/iteration))

    # print(take_time_dict)
    total=0
    count=0
    print("Avg execution times of layers")
